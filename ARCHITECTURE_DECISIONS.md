...
- **24 automated tests**, fully offline (mocked LLM, local fixture pages, no real API/network needed), covering the full loop, both arms, the safety-decline path, and the pluggable confirmation mechanism.
